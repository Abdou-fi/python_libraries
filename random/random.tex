...
\section{What is the Random Module?}\label{what-is-the-random-module}
...
1
    ...
    \section{Why Use the random Module?}\label{why-use-the-random-module}
...
colors for an art project, this module does it all.
    ...
    \section{Tips \& Tricks for the random
Module}\label{tips-tricks-for-the-random-module}

\subsection{random.seed() for Repeatable
...
4.043849779650302
    ...
    \subsection{random.sample() to Pick Multiple Items}\label{random.sample-to-pick-multiple-items}

Want to pick multiple random items without repeating? Use random.sample().
...
['Bob', 'Alice']
    ...
    \section{Basic Functions of the random
Module}\label{basic-functions-of-the-random-module}

\subsection{random.randint(a, b)}\label{random.randinta-b}
...
4
    ...
    \subsection{random.choice (list)}\label{random.choice-list}
...
Bob
    ...
    \subsection{random.random()}\label{random.random}
...
0.43276706790505337
    ...
    \subsection{random.shuffle (list)}\label{random.shuffle-list}
...
\subsection{a simple number guessing game}\label{a-simple-number-guessing-game}
...
Oops sorry, The number is 0 better luck next time.
    ...
    \subsection{Examples of using random module}\label{examples-of-using-random-module}
...
5.151399445618591
    ...
    \subsection{random vs secrets for generating random numbers}\label{random-vs-secrets-for-generating-random-numbers}
