\documentclass[11pt]{article}
    ...
    \title{\textbf{\textit{Pandas - Data Correlations}}}
...
It contains explanation, code snippets and outputs related to data correlation using the \textbf{\emph{Pandas}} library.
For any question or remark please email me or send a request throught my github.


    
    \section{Finding Relationships}\label{i.-finding-relationships}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{correlation-coefficient.png}
    \label{fig:myfigure}
\end{figure}

A great aspect of the Pandas module is the corr() method. The corr()
...
\end{tcolorbox}
    ...
    \section{Result Explained}\label{ii.-result-explained}

The Result of the corr() method is a table with a lot of numbers that
represents how well the relationship is between two columns. The number
varies from -1 to 1. 1 means that there is a 1 to 1 relationship (a
perfect correlation), and for this data set, each time a value went up
in the first column, the other one went up as well. 0.9 is also a good
relationship, and if you increase one value, the other will probably
increase as well. -0.9 would be just as good relationship as 0.9, but if
you increase one value, the other will probably go down. 0.2 means NOT a
good relationship, meaning that if one value goes up does not mean that
the other will.
...
correlation.
    ...
    \section{Perfect Correlation:}\label{iii.-perfect-correlation}
...
itself.
    ...
    \section{Good Correlation:}\label{iv.-good-correlation}
...
lot of calories, you probably had a long work out.

    \section{Bad Correlation:}\label{v.-bad-correlation}
...
just looking at the duration of the work out, and vice versa.
